...
The saltext-pagerduty project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-pagerduty.git
...
* Writing blog posts
* Sharing your experiences using Salt + PagerDuty
  on social media
